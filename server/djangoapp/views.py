...
def get_dealer_details(request, dealer_id):
    context = {}
    if request.method == "GET":
        url = 'https://b8578b0f.us-south.apigw.appdomain.cloud/reviews/get-review'
...
def add_review(request, dealer_id):
    if request.method == "GET":
        dealersid = dealer_id
        url = "https://b8578b0f.us-south.apigw.appdomain.cloud/dealerships/dealer-get?dealerId={0}".format(dealersid)
        # Get dealers from the URL
        context = {
    ...
    if request.method == "POST":
        if request.user.is_authenticated:
            ...
            print (json_payload)
            url = "https://b8578b0f.us-south.apigw.appdomain.cloud/reviews/review-post"
